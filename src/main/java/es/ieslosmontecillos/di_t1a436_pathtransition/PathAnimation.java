package es.ieslosmontecillos.di_t1a436_pathtransition;
...
public class PathAnimation extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        root.setOnMousePressed(event -> pathTransition.pause());

        root.setOnMouseReleased(event -> pathTransition.play());
